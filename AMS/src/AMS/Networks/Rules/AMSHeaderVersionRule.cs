...
namespace AMS.Networks.Rules
{
   /// <summary>
   /// Checks if <see cref="AMSMain"/> network block's header has a valid block version.
   /// </summary>
   public class AMSHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
