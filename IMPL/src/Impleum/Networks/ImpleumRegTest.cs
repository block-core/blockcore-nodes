...
namespace Impleum.Networks
{
   public class ImpleumRegTest : ImpleumMain
   {
      public ImpleumRegTest()
      {
         ...
         Name = ImpleumSetup.RegTest.Name;
         CoinTicker = ImpleumSetup.RegTest.CoinTicker;
         Magic = ConversionTools.ConvertToUInt32(ImpleumSetup.Magic, true);
         RootFolderName = ImpleumSetup.RegTest.RootFolderName;
         ...
         Checkpoints = ImpleumSetup.RegTest.Checkpoints;
         DNSSeeds = ImpleumSetup.RegTest.DNS;
         SeedNodes = ImpleumSetup.RegTest.Nodes;
         ...
         Assert(Consensus.HashGenesisBlock == uint256.Parse(ImpleumSetup.RegTest.HashGenesisBlock));
         Assert(Genesis.Header.HashMerkleRoot == uint256.Parse(ImpleumSetup.RegTest.HashMerkleRoot));
